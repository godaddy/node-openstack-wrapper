...
* getProjectToken(generic_token_value, project_id, callback)
...
* setRequest(request_lib)
* setMangler(mangler_lib)
* listSecurityGroups(project_id, callback)
* getSecurityGroup(group_id, callback)
* createSecurityGroup(group_name, group_description, callback)
* updateSecurityGroup(group_id, data_object, callback)
* removeSecurityGroup(group_id, callback)
