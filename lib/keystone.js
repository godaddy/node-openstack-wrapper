...
Keystone.prototype.getProjectTokenForReal = function(auth_data, cb)
{
  ...
  console.log('for real request_options', util.inspect(request_options, {depth: null}));
...
Keystone.prototype.listProjects = function(username, access_token, cb)
{
  ...
  console.log('request options for listProjects are', request_options);
  this.request.get(request_options, function(error, response, body){
    console.log('this is your response bod', body);
    var projects_array =[];
