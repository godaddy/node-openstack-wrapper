...
Keystone.prototype.listProjectMeta = function(project_token, project_id, cb)
{
  ...
  request_options = this.getRequestOptions(auth_token, '/projects/' + project_id + '/meta', true);
...
//make a callback(error) after listing all of the project meta data
//calls back with cb(error, meta_object)
Keystone.prototype.updateProjectMeta = function(project_token, project_id, environment_id, owning_group_id, cb)
{
  var self = this;
  var request_options = {};
  var meta_data = {
