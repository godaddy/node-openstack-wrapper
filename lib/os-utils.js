...
//the return value will be an array whose last element is the last element in the passed in args
//and whose length equals the passed in expected length based on the function signature
//I.E.:
//  getArgsWithCallback(2, ["param1"])
//  will return [undefined, "param1"]
 function getArgsWithCallback(expected_length, arg_array) {
  var return_args = [];
  var i = 0;

  if(Array.isArray(arg_array))
  {
    var cb = arg_array.pop();
