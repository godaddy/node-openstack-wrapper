...
defineError('ApiError',             'API Error',                   500);
...
defineError('AuthServerError',      'Auth Server Error',           500);
defineError('AuthUnavailableError', 'Auth Server Unavailable',     500);
...
defineError('InvalidIdError',       'Invalid Resource Identifier', 400);
