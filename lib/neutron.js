...
Neutron.prototype.listFloatingIps = function(options, cb){
  ...
  var args = osutils.getArgsWithCallback(this.listFloatingIps.length, Array.prototype.slice.call(arguments));
  options = args[0] || {};
  cb = args[1];
...
Neutron.prototype.listPorts = function(options, cb){
  ...
  // get the actual args passed in as this function can be overloaded
  var args = osutils.getArgsWithCallback(this.listPorts.length, Array.prototype.slice.call(arguments));
  options = args[0] || {};
  cb = args[1];
