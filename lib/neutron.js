...
Neutron.prototype.listPorts = function(cb){
  ...
  this.request.get(request_options, function(error, response, body){
    ...
    console.log('this is your ports body', body);
...
Neutron.prototype.updatePort = function(port_id, data, cb){
  ...
  console.log('These are your update request options', request_options);
...
Neutron.prototype.createSecurityGroup = function(group_name, group_description, cb){
  ...
  console.log('request_options are', request_options);
...
Neutron.prototype.createSecurityGroupRule = function(group_id, data, cb){
  var self = this;
  var optional_keys = ['ethertype', 'protocol', 'port_range_min', 'port_range_max', 'remote_ip_prefix', 'remote_group_id'];
