...
Neutron.prototype.updateSecurityGroup = function(group_id, group_name, group_description, cb){
  var self = this;
  var put_data = {security_group: {name: group_name, description: group_description}};
...
Neutron.prototype.createSecurityGroupRule = function(group_id, data, cb){
  ...
  if(typeof data.ether_type !== undefined)
  {
    post_data.security_group.ethertype = data.ether_type;
  }
  if(typeof data.ip_protocol !== undefined)
  {
    post_data.security_group.protocol = data.ip_protocol;
  }
  if(typeof data.port_range_min !== undefined)
  {
    post_data.security_group.port_range_min = data.port_range_min;
  }
  if(typeof data.port_range_max !== undefined)
  {
    post_data.security_group.port_range_max = data.port_range_max;
  }
  if(typeof data.remote_ip_prefix !== undefined)
  {
    post_data.security_group.remote_ip_prefix = data.remote_ip_prefix;
  }
  if(typeof data.remote_group_id !== undefined)
  {
    post_data.security_group.remote_group_id = data.remote_group_id;
  }
